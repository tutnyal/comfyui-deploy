...
//         // case "runpod-serverless":
//         //   const data = {
//         //     workflow: workflow_api, // Ensure this contains the necessary workflow details
//         //     prompt_id: prompt_id,
//         //     status_endpoint: `${origin}/api/update-run`,
//         //     file_upload_endpoint: `${origin}/api/file-upload`,
//         //   };

//         //   console.log("Payload sent to RunPod:", JSON.stringify(data, null, 2)); // Added for debugging
...
//         //   if (!__result.ok)
//         //     throw new Error(
//         //       `Error creating run, ${__result.statusText} ${await __result.text()}`,
//         //     );
//         //   console.log(data, __result);
//         //   break;
...
export const createRun = withServerPromise(
  async ({
    ...
    let prompt_id: string | undefined = undefined;
    const shareData = {
      workflow: workflow_api, // Changed from 'workflow_api_raw' to 'workflow'
      status_endpoint: `${origin}/api/update-run`,
      file_upload_endpoint: `${origin}/api/file-upload`,
    };
    ...
    try {
      switch (machine.type) {
        ...
        case "modal-serverless":
          ...
          console.log("Payload sent to ComfyDeploy Serverless:", JSON.stringify(_data, null, 2));
